<?php /* Smarty version 2.6.26, created on 2010-04-22 01:51:41
         compiled from .//OmegaTrick/examples/trick/listunit.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'clean', './/OmegaTrick/examples/trick/listunit.html', 2, false),)), $this); ?>
...
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?><?php echo '<!-- /Omega Trick --><!-- Ext Direct --><script type="text/javascript" src="'; ?><?php echo $this->_tpl_vars['relpath']; ?><?php echo 'extdirect.html"></script><!-- /Ext Direct --><!-- Application --><script type="text/javascript" src="listunit.js"></script><!-- /Application --></body></html>'; ?><?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_clean($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?><?php echo ''; ?>
